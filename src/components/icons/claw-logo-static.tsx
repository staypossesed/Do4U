interface ClawLogoStaticProps {
  size?: number;
  className?: string;
}

export function ClawLogoStatic({ size = 32, className }: ClawLogoStaticProps) {
  return (
    <div className={className}>
      ...
      >
        <defs>
          <linearGradient id="clawGradStatic" x1="0%" y1="0%" x2="100%" y2="100%">
            <stop offset="0%" stopColor="#ff6b2b" />
            <stop offset="100%" stopColor="#7c3aed" />
          </linearGradient>
        </defs>
        <circle cx="24" cy="24" r="22" fill="url(#clawGradStatic)" />
